...
<div class="ht__comment__form">
    <h4 class="title__line--5">Оставить отзыв</h4>
    ...
    <div class="table__right-column">
        ...
        <div class="ht__comment__btn">
            <a class="review_submit <?php if(Yii::app()->user->isGuest) :?>button_disabled<?php endif; ?>"><i class="icon-envelope icons"></i>Отправить</a>
        </div>
    </div>
</div>

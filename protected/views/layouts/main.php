...
<head>
    ...
    <script async language="javascript" type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/js/magiczoom.js"></script>
    <script async src="<?php echo Yii::app()->request->baseUrl; ?>/js/social-likes.min.js"></script>

...
class Controller extends CController
{
    ...
    public function addGetParamToCurrentUrl($paramKey, $paramValue, $currentUrl = null){
        if(!$currentUrl) $currentUrl = Yii::app()->request->requestUri;
    ...
    public function getParamFromCurrentUrl(){

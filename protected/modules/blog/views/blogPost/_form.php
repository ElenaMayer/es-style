...
<script>
	...
	function translit(ru_str) {
		var translitJson = '{"Я":"Ya","я":"ya","Ю":"Yu","ю":"yu","Ч":"Ch","ч":"ch","Ш":"Sh","ш":"sh","Щ":"Sh","щ":"sh","Ж":"Zh","ж":"zh","А":"A","а":"a","Б":"B","б":"b","В":"V","в":"v","Г":"G","г":"g","Д":"D","д":"d","Е":"E","е":"e","Ё":"E","ё":"e","З":"Z","з":"z","И":"I","и":"i","Й":"J","й":"j","К":"K","к":"k","Л":"L","л":"l","М":"M","м":"m","Н":"N","н":"n","О":"O","о":"o","П":"P","п":"p","Р":"R","р":"r","С":"S","с":"s","Т":"T","т":"t","У":"U","у":"u","Ф":"F","ф":"f","Х":"H","х":"h","Ц":"C","ц":"c","Ы":"Y","ы":"y","Э":"E","э":"e"," ":"_"}';
		var translitArr = jQuery.parseJSON(translitJson);
		var en_str = '';
		for (var i = 0, len = ru_str.length; i < len; i++) {
			if ($.inArray(ru_str[i], ["Ь","ь","Ъ","ъ",".","!","?"]) < 0) {
				if (translitArr[ru_str[i]])
